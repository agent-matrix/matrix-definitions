...
Current task:
T02-analyze-api: implement the endpoint using the enterprise-safe policy.
...
IBM Bob-specific instruction: preserve governance and audit assumptions; do not introduce unapproved services.
